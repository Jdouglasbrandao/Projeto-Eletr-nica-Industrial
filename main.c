...
float ResistorA, ResistorB,  ResistorC, ResistorD,  ResistorE,  ResistorF,  Receptor,  Gerador, TensaoPrimaria, Numero_Espiras1, Numero_Espiras2, Capacitancia, Resistencia_Carga, Frequencia;
int numero;
...
int main (){
  ...
  void CalculoCircuito_A (void){
            ...
            if (Corrente_A < 0){
                Corrente_A = Corrente_A * (-1);
        
                  }
           if (Corrente_B < 0){
            Corrente_B = Corrente_B * (-1);
  
            }
      
           if (Corrente_C < 0){
           Corrente_C = Corrente_C * (-1);
            ...
            float Potencia_ProduzidaG = Gerador*Corrente_A;
             ...
             printf ("  ----------------------------------------------------------------------------\n\n");
             printf ("  Corrente que percorre o resistor A = %.2fA\n", Corrente_A);
             printf ("  Corrente que percorre o resistor B = %.2fA\n", Corrente_B);
             printf ("  Corrente que percorre o resistor C = %.2fA\n", Corrente_B);
             printf ("  Corrente que percorre o resistor D = %.2fA\n", Corrente_A);
             printf ("  Corrente que percorre o resistor E = %.2fA\n", Corrente_A);
             printf ("  Corrente que percorre o resistor F = %.2fA\n", Corrente_C);
 ...
 void EntradaValores_B (void){
     ...
     char Palavra;
       ...
       do{
            ...
            Retorno = scanf ("%f", &TensaoPrimaria);
           if (Retorno == 0){
               printf ("\n\n  *********************************************\n");
               printf ("  Entrada inválida, por favor digite um número \n");
               printf ("  *********************************************\n\n");
     ...
     do{
          ...
          Retorno = scanf ("%f", &Numero_Espiras1);
         if (Retorno == 0){
             printf ("\n\n  *********************************************\n");
             printf ("  Entrada inválida, por favor digite um número \n");
             printf ("  *********************************************\n\n");
     ...
     do{
          ...
          Retorno = scanf ("%f", &Numero_Espiras2);
         if (Retorno == 0){
             printf ("\n\n  *********************************************\n");
             printf ("  Entrada inválida, por favor digite um número \n");
             printf ("  *********************************************\n\n");
     ...
     do{
          ...
          Retorno = scanf ("%f", &Resistencia_Carga);
         if (Retorno == 0){
             printf ("\n\n  *********************************************\n");
             printf ("  Entrada inválida, por favor digite um número \n");
             printf ("  *********************************************\n\n");
 ...
 void CalculoCircuito_B (void){
            float V2 = TensaoPrimaria*Numero_Espiras2/Numero_Espiras1;
            float V2P = V2*sqrt(2);
            float VCP = V2P-0.7;
            
            float C = Capacitancia*0.000001;
            float RL = Resistencia_Carga*1000;
            float i = VCP/RL;
            float Vond = i/(Frequencia*C);
            ...
            float Vmedio = (Vminimo+VCP)/2;
             ...
             printf ("  -------------------------------- RESULTADO ---------------------------------\n");
             printf ("  ----------------------------------------------------------------------------\n\n");
             printf ("  Tensão de pico no capacitor = %.2fV\n", VCP);
             printf ("  Tensão de Ripple            = %.2fV\n", Vond );
             printf ("  Tensão  média na carga      = %.2fV\n", Vmedio);
        }
